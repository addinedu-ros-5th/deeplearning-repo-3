...
if __name__ == "__main__":
    ...
    # Set default values for log_path and note if they are None or empty
    if cfg.log_path is None:
        cfg.log_path = '/home/addinedu/lane_detect/Ultra-Fast-Lane-Detection/logs'  # 기본 경로로 설정
    if cfg.note is None or cfg.note == '':
        cfg.note = 'default_note'  # 기본 값으로 설정
